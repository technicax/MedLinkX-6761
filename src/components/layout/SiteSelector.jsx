          ...
          <>
            ...
            >
              <div className="p-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">Switch to a different medical facility</p>
              </div>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm text-gray-600 mb-2">{site.type} • {site.beds} beds</div>
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200">
                <div className="text-xs text-gray-500 text-center">
                  All data and communications are isolated per hospital facility
                </div>
              </div>
            </motion.div>
          </>
